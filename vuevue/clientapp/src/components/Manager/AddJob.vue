<template>
    <div id="add-manager">
        ...
        <form v-if="!submitted">
            ...
            <input type="password" v-model.lazy="job.location" placeholder="Password" required />
            <label>Password</label>
            <input type="password" v-model.lazy="job.comments" placeholder="Password" required />
...
export default {
    ...
    methods:{
        ...
        EndDate() {
            ...
            this.days.expirationDate = moment;
        },
    },
}
</script>
